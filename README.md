...
가상의 음원 사이트 MIL 에서 음악 감상을 즐길 수 있는 웹 어플리케이션 입니다. <br>
프로젝트에 사용된 음원은 [NCS](https://ncs.io/)에서 다운로드 받았습니다. (🎧 <a name="#copyright">음원 저작권</a>) <br>
웹 디자인은 Spotify를 참고하여 제작하였습니다.
...
#### seekBar가 정상적으로 음원의 진행 상황을 반영하지 못 하는 이슈
